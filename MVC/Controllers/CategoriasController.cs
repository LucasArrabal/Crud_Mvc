...
namespace MVC.Controllers
{
    public class CategoriasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Deescricao")] Categoria categoria)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Deescricao")] Categoria categoria)
        {
            if (id != categoria.Id)
            {
                return NotFound();
